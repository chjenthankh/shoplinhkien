...
class ProductController extends Controller
{
    ...
    public function search(Request $request){
        $keywords = $request->keywords_sp;
        $all_product=DB::table('tbl_product')
        ->join('tbl_category_product','tbl_category_product.category_id','=','tbl_product.category_id')
        ->join('tbl_brand','tbl_brand.brand_id','=','tbl_product.brand_id')->orderby('tbl_product.product_id','desc')->paginate(10);
        $search_sp = DB::table('tbl_product')->where('product_name','like','%'.$keywords.'%')->join('tbl_category_product','tbl_category_product.category_id','=','tbl_product.category_id')->join('tbl_brand','tbl_brand.brand_id','=','tbl_product.brand_id')->get(); 
        $manager_product=view('admin.search_sp')->with('all_product',$all_product)->with('search_sp',$search_sp);
        

        return view('admin_layout')->with('admin.search_sp',$manager_product);
    }
}
